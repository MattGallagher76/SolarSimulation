...
namespace Valve.VR
{
    ...
    public class SteamVR_Input_ActionSet_default : Valve.VR.SteamVR_ActionSet
    {
        ...
        public virtual SteamVR_Action_Boolean LeftTouchPadButton
        {
            get
            {
                return SteamVR_Actions.default_LeftTouchPadButton;
            }
        }
        
        public virtual SteamVR_Action_Boolean RightTouchPadButton
        {
            get
            {
                return SteamVR_Actions.default_RightTouchPadButton;
            }
        }
